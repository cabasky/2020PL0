...
void getsym(void)
{
	...
	else if (isdigit(ch))//�����һ���ַ������֣���ôsymbol��������
	{ // symbol is a number.
		k = num = 0;
		sym = SYM_NUMBER;
		do
...
void gen(int x, int y, int z)//�ۺ�ָ���ָ���ŵ�code��
{
	if (cx > CXMAX)
	{
...
int position(char* id)//Ѱ��id��table�е�λ��
{
	int i;
...
void constdeclaration()//��������
{
	if (sym == SYM_IDENTIFIER)
	{
		...
		{
			if (sym == SYM_BECOMES)
				error(1); // Found ':=' when expecting '='������Ա�������׻���=��:=���÷�
			getsym();
			if (sym == SYM_NUMBER)
			{
				enter(ID_CONSTANT);
...
//////////////////////////////////////////////////////////////////////
void listcode(int from, int to)//��ӡ��from��to������ָ��
{
	int i;
...
//////////////////////////////////////////////////////////////////////
void factor(symset fsys)//�ֽ�һ��symbol����
{
	...
	if (inset(sym, facbegsys))//sym�����ڴ�����symbol
	{
		if (sym == SYM_IDENTIFIER)//���sym��������id
		{
			if ((i = position(id)) == 0)//���Table��û�����id
			{
		...
		else if (sym == SYM_NUMBER)//���sym��������number
		{
			if (num > MAXADDRESS)
			{
				error(25); // The number is too great.
...
void term(symset fsys)
{
	...
	factor(set);
	while (sym == SYM_TIMES || sym == SYM_SLASH)//���sym��*����/
	{
		mulop = sym;
		getsym();
		factor(set);
...
void block(symset fsys)//������
{
	...
	do
	{
		...
		{ // constant declarations
			...
			{
				constdeclaration();
				while (sym == SYM_COMMA)//COMMA�Ƕ���
				{
					getsym();
					constdeclaration();
				}
				if (sym == SYM_SEMICOLON)//SEMICOLON�Ƿֺ�
				{
					getsym();
				}
				else
